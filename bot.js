...
if (message.content === '^^support') {
      message.author.send(' |https://discord.gg/CwWaQDG| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/oauth2/authorize?client_id=524946242363719692&scope=bot&permissions=2146958591 ').catch(e => console.log(e.stack));
